...
var PostgresTree =
  ...
  (function() {
    ...
    _createClass(PostgresTree, [
      ...
      {
        key: "insertNode",
        value: async function insertNode(_ref8, x, y) {
          var id = _ref8.id,
            name = _ref8.name,
            offset = _ref8.offset;
          var text = "\nWITH insert_node AS (\n  INSERT INTO "
          ...
          var _ref9 = await this.client.query(text, values),
            rows = _ref9.rows;
      ...
      },
      {
        ...
        value: async function replacingInsertNode(_ref10) {
          var id = _ref10.id,
      ...
      },
      {
        ...
        value: async function getLeaves() {
          ...
          var _ref12 = await this.client.query(text),
            rows = _ref12.rows;
      ...
      },
      {
        ...
        value: async function createView() {
          ...
          var _ref13 = await this.client.query(
              "SELECT * FROM ".concat(this.table + "_view", ";")
            ),
            rows = _ref13.rows;
